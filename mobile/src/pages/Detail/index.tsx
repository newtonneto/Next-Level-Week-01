...
const Detail = () => {
    ...
    //Como data é um objeto, dentro do useState colocar {}
    ...
    return (
        //A SafeAreaView cria um padding automatico para evitar que itens do app colidam com areas indesejadas,
        //como as statusbar com notch
